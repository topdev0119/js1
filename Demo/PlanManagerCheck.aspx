<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanManagerCheck.aspx.cs" Inherits="H3C.iLab.UI.Web.MaterialApproval.PlanManagerCheck" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <table id="Material" style="width: 2300px;" forUpdate=true class="tableblue"   PageSize="10" showpager=true pageprompt="detailpage"  url="MaterialHandler.ashx?method=SearchMaterialPlanManagerCheck">
                <tr>
                    ...
                    <th id="action" width="60px" frozen="true" rowspan="2">详情<a href="#" onclick="SearchMe(this)">审批详情</a></th>
        ...
        <script>
            ...
            function saveNewPerson() {
                ...
                var data = { "Status": 40, "CurrPerson": "<%=UserCode%>", "NewPerson": newperson };
            ...
            function GetPMcheckTotal() {
                Ajax("MaterialHandler.ashx?method=GetPlanManagercheckTotal",
                    "GET",
                    "",
                    function (data) {
                        if (data) {
            ...
            function Save() {
                ...
                if (data.length > 0) {
                    Ajax("MaterialHandler.ashx?method=SaveMaterialAuditPlanManager" ,
                        "Post",
                        data,
                        function (text) {
                            if (text) {
            ...
            function Submit() {
                ...
                Ajax("MaterialHandler.ashx?method=PlanManagerCheckSubmit",
                    "Post",
                    data,
                    function (text) {
                        if (text) {
